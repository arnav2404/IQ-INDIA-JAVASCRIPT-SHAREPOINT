...
// let attendancePercentage = parseInt(prompt("Enter Your Percentage : "));
// (attendancePercentage >= 75)  ? document.write(<h1>You are eligible to sit in Exam</h1>):document.write(<h1>You are not eligible to sit in exam</h1>)
...
// // Function to calculate the tax based on the car brand and price
// function calculateTax(brand, price) {
//     /**
//      * Calculate the tax for a car purchase based on the car brand and price.
//      *
//      * @param {string} brand - The brand of the car (e.g., "Mahindra", "Audi", "Jaguar", "Mercedes").
//      * @param {number} price - The price of the car in lakhs (L).
//      * @returns {number|null} - The calculated tax amount or null if no tax applies.
//      */
//     let taxRate = 0;

//     if (brand === "Mahindra" && price >= 7 && price <= 10) {
//         taxRate = 5;
//     } else if (brand === "Audi" && price >= 10 && price <= 15) {
//         taxRate = 10;
//     } else if (brand === "Jaguar" && price >= 15 && price <= 20) {
//         taxRate = 25;
//     } else if (brand === "Mercedes" && price >= 20 && price <= 25) {
//         taxRate = 30;
//     }
...
// }
// (function () {
//     const brand = prompt("Enter the car brand:");
//     const priceInput = prompt("Enter the car price in lakhs:");
...
//     } else {
//         const tax = calculateTax(brand, price);

//         if (tax !== null) {
//             console.log(`The tax for the ${brand} car priced at ${price}L is: ${tax}L`);
//         } else {
//             console.log(`No applicable tax for the ${brand} car priced at ${price}L.`);
//         }
//     }
// })();
