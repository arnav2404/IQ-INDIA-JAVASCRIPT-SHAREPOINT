...
function Create_Profile(img_path, user_name, user_contact, user_address, user_bio){
    document.write(`
        <div style="margin:auto; width:40%; height:30vh; border: 1px solid red;">
            <img src="${img_path}" alt="missing">
            <div>
                <span>Name : ${user_name || 'NOT AVAILABLE'}</span>
                <br>
                <span>Name : ${user_contact || 'NOT AVAILABLE'}</span>
                <br>
                <span>Name : ${user_address || 'NOT AVAILABLE'}</span>
                <br>
                <span>Name : ${user_bio || 'NOT AVAILABLE'}</span>
                <br>
                <button>Follow</button>
                <button>Edit</button>
            </div>
...
let img_path=prompt("Enter Image Path : ")
let user_name=prompt("Enter User Name: ")
let user_contact=prompt("Enter User Contact: ")
let user_address=prompt("Enter User Address: ")
let user_bio=prompt("Enter User Bio: ")

Create_Profile(img_path, user_address, user_name, user_bio, user_contact)
